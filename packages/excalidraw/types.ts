import type { IMAGE_MIME_TYPES, MIME_TYPES, UserIdleState, throttleRAF } from '@excalidraw/common';
...
import type { MakeBrand, MaybePromise, Merge, ValueOf } from '@excalidraw/common/utility-types';
...
export interface AppState {
    ...
    openDialog: null | { name: 'imageExport' | 'help' | 'jsonExport' } | { name: 'ttd'; tab: 'text-to-diagram' | 'mermaid' } | { name: 'commandPalette' } | { name: 'elementLinkSelector'; sourceElementId: ExcalidrawElement['id'] };
...
export type GenerateDiagramToCode = (props: { frame: ExcalidrawMagicFrameElement; children: readonly ExcalidrawElement[] }) => MaybePromise<{ html: string }>;
