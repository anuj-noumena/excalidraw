...
export const isFirefox = typeof window !== 'undefined' && 'netscape' in window && navigator.userAgent.indexOf('rv:') > 1 && navigator.userAgent.indexOf('Gecko') > 1;
...
export function getGenericFontFamilyFallback(fontFamily: number): keyof typeof FONT_FAMILY_GENERIC_FALLBACKS {
    switch (fontFamily) {
...
export const ALLOWED_PASTE_MIME_TYPES = [MIME_TYPES.text, MIME_TYPES.html, ...Object.values(IMAGE_MIME_TYPES)] as const;
